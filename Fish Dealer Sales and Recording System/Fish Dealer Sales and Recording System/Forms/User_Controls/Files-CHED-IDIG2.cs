...
namespace Fish_Dealer_Sales_and_Recording_System
{
    public partial class Files : UserControl
    {
        ...
        private void Reset()
        {
            ...
            Date.Checked = false;
            NoofTub.Checked = false;
            NoofKilo.Checked = false;
            UnitTubPrice.Checked = false;
            UnitKiloPrice.Checked = false;
            KindofFish.Checked = false;
            tbVendor.Text = "";
            cbKindofFish.Text = "";
            tbNoofTub.Text = "";
            tbNoofKilo.Text = "";
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            while (queue.Count > 0)
            {
                foreach (Control control in FileInputPanel.Controls)
                {
                    if (queue.Count > 1)
                    {
