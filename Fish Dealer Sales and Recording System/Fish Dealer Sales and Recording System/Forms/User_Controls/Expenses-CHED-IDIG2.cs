...
namespace Fish_Dealer_Sales_and_Recording_System
{
    public partial class Expenses : UserControl
    {
        ...
        private void Expenses_Load(object sender, EventArgs e)
        {
            ...
            //DataTableConnector tableConnector = new DataTableConnector();

            //dgvExpenses.DataSource = tableConnector.DataTableWeekPrint();
        }
        ...
        private void BtnAdd_Click(object sender, EventArgs e)
        {
            ...
            expensesConnector.InsertExpenses(expensesProperties);
            dgvExpenses.DataSource = expensesConnector.ReadExpeses(IDClass);
            ClearField();
        }
